...
<div class="relative min-h-screen overflow-x-hidden bg-[#121212] text-white">
	<nav
	...
	>
		...
		<div class="flex items-center space-x-12">
			<div class="hidden space-x-10 md:flex">
				<a
					href="/"
					class="text-[10px] font-bold tracking-[0.2em] uppercase transition-colors {page.url
						.pathname === '/'
						? 'text-white'
				...
				<a
					...
					class="text-[10px] font-bold tracking-[0.2em] uppercase transition-colors {page.url
						.pathname === '/about'
						? 'text-white'
						: 'text-blue-500 hover:text-white'}">About</a
				>
				<a
					href="/courses"
					class="text-[10px] font-bold tracking-[0.2em] uppercase transition-colors {page.url
						.pathname === '/courses'
						? 'text-white'
						: 'text-blue-500 hover:text-white'}">Courses</a
				>
			</div>
			<a
				href="/contact"
...
transition-all active:scale-95 {page.url.pathname === '/contact'
	...
	>
		...
		<a
			...
			target="_blank"
			class="text-blue-500 transition-all hover:scale-125 hover:text-pink-500"
		>
			<svg class="h-5 w-5 fill-current" viewBox="0 0 24 24"
				><path
		...
		<a
			...
			target="_blank"
			class="text-blue-500 transition-all hover:scale-125 hover:text-green-500"
		>
			<svg class="h-5 w-5 fill-current" viewBox="0 0 24 24"
				><path
...
<div class="fixed right-16 bottom-8 z-[90] hidden text-right md:block">
	<div class="flex flex-col space-y-2">
		<div class="text-[10px] font-bold tracking-[0.2em] text-white uppercase transition-colors">
			anvaya@tattvum.com
		</div>
		<div class="text-[10px] font-bold tracking-[0.2em] text-white uppercase transition-colors">
			+91 - 80735 36708
