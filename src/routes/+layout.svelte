		...
		<div class="grid grid-cols-1 items-center gap-8 md:grid-cols-3">
			...
			<div class="flex items-center justify-center gap-6">
				...
				>
					<svg class="h-6 w-6 fill-current" viewBox="0 0 24 24"
						><path
							d="M12 2.163c3.204 0 3.584.012 4.85.07 1.266.058 1.644.07 4.849.07 3.205 0 3.584-.012 4.849-.07 1.266-.058 1.644-.07 4.849-.07s.384.012.485.07c1.266.058 1.644.07 4.849.07s3.584-.012 4.849-.07c.058-1.266.07-1.644.07-4.849 0-3.204-.012-3.584-.07-4.85-.058-1.266-.07-1.644-.07-4.849 0-3.204.012-3.584.07-4.85.058-1.266.07-1.644.07-4.849zm0 0zm0 5a5 5 0 1 0 0 10 5 5 0 0 0 0-10zm0 8a3 3 0 1 1 0-6 3 3 0 0 1 0 6zm6.5-11.5a1 1 0 1 1-2 0 1 1 0 0 1 2 0z"
						/></svg
					>
				</a>
				<a
